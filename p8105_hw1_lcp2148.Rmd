...
The size of the data set is `nrow(penguins)` 344 penguins and `ncol(penguins)`8 variables (corroborated above).

The mean flipper length is `meanflip = mean(penguins$flipper_length_mm, na.rm = TRUE)` 200.915